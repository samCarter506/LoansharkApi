        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Bankings_Applications_ApplicationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Employers_Applications_ApplicationId",
                        column: x => x.ApplicationId,
                        principalTable: "Applications",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    foodExpenses = table.Column<double>(type: "float", nullable: false),
                    transportExpenses = table.Column<double>(type: "float", nullable: false),
                    electricityExpenses = table.Column<double>(type: "float", nullable: false),
                    waterExpenses = table.Column<double>(type: "float", nullable: false),
                    existingLoanRepayments = table.Column<double>(type: "float", nullable: false),
                    otherExpenses = table.Column<double>(type: "float", nullable: false),
                    dependents = table.Column<int>(type: "int", nullable: false),
                    monthlyExpenses = table.Column<double>(type: "float", nullable: true),
                    ApplicationId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MonthlyExpense_Applications_ApplicationId",
                        column: x => x.ApplicationId,
                        principalTable: "Applications",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HomeLanguage = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Audit_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Audit_AspNetUsers_ModifiedById",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SystemCode_AspNetUsers_ModifiedUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SystemCodeDetails_AspNetUsers_ModifiedUserId",
                        column: x => x.ModifiedUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_HomeLanguage",
                table: "AspNetUsers",
                column: "HomeLanguage");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Audit_ModifiedById",
                table: "Audit",
                column: "ModifiedById");

            migrationBuilder.CreateIndex(
                name: "IX_Bankings_ApplicationId",
                table: "Bankings",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Employers_ApplicationId",
                table: "Employers",
                column: "ApplicationId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SystemCode_ModifiedUserId",
                table: "SystemCode",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SystemCodeDetails_ModifiedUserId",
                table: "SystemCodeDetails",
                column: "ModifiedUserId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AspNetUsers_SystemCodeDetails_HomeLanguage",
                table: "AspNetUsers",
                column: "HomeLanguage",
                principalTable: "SystemCodeDetails",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AspNetUsers_SystemCodeDetails_ProvinceId",
                table: "AspNetUsers",
                column: "ProvinceId",
                principalTable: "SystemCodeDetails",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AspNetUsers_SystemCodeDetails_RaceId",
                table: "AspNetUsers",
                column: "RaceId",
                principalTable: "SystemCodeDetails",
                principalColumn: "Id",
